                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    ...
                                    <span class="title text-black font-w600">{$statics.cars|number_format}</span>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="title text-black font-w600">{($statics.slots.slots - $statics.slots.booked)|number_format}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="title text-black font-w600">{$statics.slots.booked}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="title text-black font-w600">UGX {$statics.slots.booked}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                    ...
                    <div class="card avtivity-card">
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <p class="fs-14 mb-2">Clients</p>
                                    <span class="title text-black font-w600">{$statics.users}</span>
                                </div>
                            </div>
                            <div class="progress" style="height:5px;">
                                <div class="progress-bar bg-info" style="width: 45%; height:5px;" role="progressbar">
                ...
                {foreach $bookings as $booking}
                    <tr {if $booking.status == 1}class="text-danger font-weight-bolder"{/if}>
                        ...
                        <td>
                            {$booking.slot}
                            {if $booking.status == 1}
                                <a href="/checkout/{$booking.id}"><button class="btn btn-outline-secondary">CHECKOUT</button></a>
                            {else}
                                <a href="/print/{$booking.id}"><button class="btn btn-outline-info">PRINT</button></a>
                            {/if}
                        </td>
                        ...
                        <td>{$booking.type}</td>
                        <td>{$booking.rate|number_format}/hr</td>
